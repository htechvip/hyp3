    ...
    return (
        <>
            <div className="scroll-container">
                ...
                <div className="models-listing-section" style={{ backgroundColor: 'var(--color-black)', padding: '100px 50px', minHeight: '100vh' }}>
                    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                        <h2 className="models-heading" style={{ fontSize: '36px', marginBottom: '60px', textAlign: 'center', textTransform: 'uppercase' }}>Our Models</h2>

                        <div className="models-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '40px' }}>
                                ...
                                >
                                    ...
                                    <div className="insight-content" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        <div style={{ marginTop: '20px' }}>
                                            <span className="btn-insights" style={{ display: 'inline-block', pointerEvents: 'none' }}>
                                                View Details
                                            </span>
                                        </div>
                                    </div>
